...
define Package/luci-app-trojan
	...
	DEPENDS:=+luci-base +wget-ssl +unzip +ip +iptables +bash +ipset +libmbedtls +ca-certificates +iptables-mod-tproxy +pdnsd-alt +curl +dnscrypt-proxy +coreutils-base64 +luci-compat +libc
	PKGARCH:=all
